...
import gen.com.zhengping.contact.R;
...
public class AddNew extends Activity implements ViewFactory {
	...
	class ImageAdapter extends BaseAdapter {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			iv.setImageResource(images[position%images.length]);//取得图片的位置显示要显示的图片
			iv.setAdjustViewBounds(true);//适应视图的大小
			iv.setLayoutParams(new Gallery.LayoutParams(80,80));//设置大小
